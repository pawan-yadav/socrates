ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :ranking_levels, collection: {
      create_ranking_level: [:get, :post],
      edit_ranking_level: [:get, :post],
      update_ranking_level: [:get, :post],
      delete_ranking_level: [:get, :post],
      ranking_level_cancel: [:get, :post],
      change_priority: [:get, :post]
  }
  ...
  map.resources :fa_groups, collection: {
      assign_fa_groups: [:get, :post],
      new_fa_criteria: [:get, :post],
      create_fa_criteria: [:get, :post],
      edit_fa_criteria: [:get, :post],
      update_fa_criteria: [:get, :post],
      destroy_fa_criteria: [:post],
      reorder: [:get, :post]
  }
  ...
  map.resources :observation_groups, member: {
      new_observation: [:get, :post],
      create_observation: [:get, :post],
      edit_observation: [:get, :post],
      update_observation: [:get, :post],
      destroy_observation: [:post],
      reorder: [:get, :post]
  }, collection: {
      assign_courses: [:get, :post],
      set_observation_group: [:get, :post]
  }
  map.resources :cce_weightages, member: {assign_courses: [:get, :post]},
                collection: {assign_weightages: [:get, :post]}
  map.resources :cce_grade_sets, member: {
      new_grade: [:get, :post],
      edit_grade: [:get, :post],
      update_grade: [:get, :post],
      destroy_grade: [:post]
  }
  ...
  map.resources :courses, has_many: :batches, collection: {
      grouped_batches: [:get, :post],
      create_batch_group: [:get, :post],
      edit_batch_group: [:get, :post],
      update_batch_group: [:get, :post],
      delete_batch_group: [:get, :post],
      assign_subject_amount: [:get, :post],
      edit_subject_amount: [:get, :post],
      destroy_subject_amount: [:get, :post]
  }
  ...
  map.fa_scores 'assessment_scores/exam/:exam_id/fa_group/:fa_group_id',
                controller: 'assessment_scores', action: 'fa_scores'
  map.observation_scores 'assessment_scores/batch/:batch_id/observation_group/:observation_group_id',
                         controller: 'assessment_scores', action: 'observation_scores'
