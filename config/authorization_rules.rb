authorization do
  ...
  role :student_attendance_view do
    ...
    has_permission_on [:attendance_reports], to: [:index, :subject, :mode, :show, :year, :report, :filter,
                                                  :student_details, :report_pdf, :filter_report_pdf]
  ...
  role :student_attendance_register do
    ...
    has_permission_on [:attendances], to: [:index, :list_subject, :show, :new, :create, :edit, :update, :destroy,
                                           :subject_wise_register, :daily_register]
  ...
  role :add_new_batch do
    ...
    has_permission_on [:courses], to: [:index, :manage_course, :manage_batches, :find_course, :new, :create, :destroy,
                                       :edit, :update, :show, :update_batch, :grouped_batches, :create_batch_group,
                                       :edit_batch_group, :update_batch_group, :delete_batch_group, :assign_subject_amount, :edit_subject_amount, :destroy_subject_amount]
    has_permission_on [:batches], to: [:index, :new, :create, :destroy, :edit, :update, :show, :init_data,
                                       :assign_tutor, :update_employees, :assign_employee, :batches_ajax]
    ...
    has_permission_on [:student], to: [:electives, :assign_students, :unassign_students, :assign_all_students,
                                       :unassign_all_students, :profile, :guardians, :show_previous_details]
  ...
  role :sms_management do
    has_permission_on [:configuration], to: [:index]
    has_permission_on [:sms], to: [:index, :settings, :students, :batches, :employees, :departments, :all,
                                   :update_general_sms_settings, :list_students, :sms_all, :list_employees,
                                   :show_sms_messages, :show_sms_logs]
  end
  role :event_management do

    has_permission_on [:event], to: [:index, :show, :confirm_event, :cancel_event, :select_course, :event_group,
                                     :course_event, :remove_batch, :select_employee_department, :department_event,
                                     :remove_department, :edit_event]
  ...
  role :general_settings do
    ...
    has_permission_on [:student], to: [:add_additional_details, :change_field_priority, :delete_additional_details,
                                       :edit_additional_details, :categories, :category_delete, :category_edit,
                                       :category_update]
  end
  ...
  role :admin do
    ...
    has_permission_on [:sms], to: [:index, :settings, :update_general_sms_settings, :students, :list_students,
                                   :batches, :sms_all, :employees, :list_employees, :departments, :all,
                                   :show_sms_messages, :show_sms_logs]
    ...
    has_permission_on [:observations], to: [:show]
    has_permission_on [:assessment_scores],
                      to: [
                          :exam_fa_groups,
                          :fa_scores,
  ...
  role :employee do
    ...
    has_permission_on [:student_attendance], to: [:index]
    has_permission_on [:attendances], to: [:index, :list_subject, :show, :subject_wise_register, :daily_register,
                                           :new, :create, :edit, :update, :destroy]
    has_permission_on [:attendance_reports], to: [:new, :index, :subject, :mode, :show, :year, :report, :filter,
                                                  :student_details, :report_pdf, :filter_report_pdf, :student]
    has_permission_on [:cce_reports], to: [:index, :student_wise_report, :student_wise_report_pdf, :student_report,
                                           :student_report_pdf, :student_transcript]
  end
